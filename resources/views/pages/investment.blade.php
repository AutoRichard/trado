              ...
              End Countdown -->
                ...
                <!-- Charts -->
                   <article class="bg-white shadow-sm rounded">
                    ...
                    <header class="p-6">
                        <div class="d-flex justify-content-between align-items-center mb-3">
                            <h5 class="d-block text-muted">Empty Farmshop</h5>
                        </div>
                    </header>
                   </article>
                <!-- End Charts -->
            ...
            <div class="d-flex justify-content-between align-items-center">
                <nav aria-label="Page navigation">
                  <ul class="pagination mb-0">
                    @if($plantation->currentPage() > 1) 
                    <li class="page-item ml-0">
                      <a class="page-link" href="{{$plantation->previousPageUrl()}}" aria-label="Previous">
                        Previous
                      </a>
                    </li>
                    @endif
                    
                    @if($plantation->currentPage() > 1 && $plantation->currentPage() != $plantation->lastPage() && $plantation->lastPage() != 0) 
                    <li class="page-item disabled"><a class="page-link" href="#">...</a></li>
                    @endif
                    
                    @if($plantation->currentPage() != $plantation->lastPage() && $plantation->lastPage() != 0)
                    <li class="page-item">
                      <a class="page-link" href="{{$plantation->nextPageUrl()}}" aria-label="Next">
                        Next
                      </a>
                    </li>
                    @endif
