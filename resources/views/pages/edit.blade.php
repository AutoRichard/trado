...
<main id="content" role="main">
    ...
    <div class="bg-light">
        ...
        <div class="container space-2">
            <!-- Update Avatar Form -->
            <form class="media align-items-center mb-7" method="POST" action="/edit_image">
                ...
                <div class="media-body">
                    <label class="btn btn-sm btn-trado1 transition-3d-hover file-attachment-btn mb-1 mb-sm-0 mr-1"
                ...
                <script>
                    $(function(){
                        let loading = '/img/loading/loaders.gif';
                        let prev_profile = '/storage/'+"<?php echo auth::user()->profile_image; ?>";
                            ...
                            function readImgUrlAndPreview(input){
                                if(input.files && input.files[0]){
                                    ...
                                    reader.onload = function(e){ 
                                        $('img#profile').attr('src', loading);
                                        let files = new FormData();
                                        files.append('profile_image', $('#fileAttachmentBtn')[0].files[0]);
                                        $.ajax({
                                            type: 'post',
                                            url: "/edit_image",
                                            ...
                                            success: function(data){
                                                if(data == 'save'){
                                                    ...
                                                    setTimeout(function(){
                                                       $('img#profile').attr('src', prev_profile);
                                                    }, 500);
                                                }
                                            },
                                            error: function(){
            ...
            <!-- Personal Info Form -->
            <form class="js-validate" method="POST" action="/edit_info">
                {{ csrf_field() }}
                <div class="row">
                    <!-- Input -->
                        ...
                        <div class="js-form-message">
                            ...
                            <div class="form-group">
                                <input type="text" class="form-control" name="name"
                                    ...
                                    data-error-class="u-has-error" data-success-class="u-has-success" value="{{old('name') == NULL ? auth::user()->name : old('name')}}" />
                    ...
                    <div class="col-sm-6 mb-6">
                        <div class="js-form-message">
                            ...
                            <div class="form-group">
                                <input class="form-control" type="tel" name="whatsapp_contact"
                                    placeholder="Enter your whatsapp number" aria-label="Enter your whatsapp number"
                                    required aria-describedby="phoneNumberLabel"
                                    data-msg="Please enter a valid whatsapp number" data-error-class="u-has-error"
                                    data-success-class="u-has-success" value="{{old('whatsapp_contact') == NULL ? auth::user()->whatsapp_contact : old('whatsapp_contact')}}" />
                            </div>
                        </div>
                    </div>
                    <!-- End Input -->                    
                ...
                <!-- Buttons -->
                <button type="submit" class="btn btn-sm btn-trado transition-3d-hover mr-1">Save Changes</button>
                <!-- End Buttons -->
            </form>
